    ...
    >
      ...
      {selectedProject && (
        ...
        >
          ...
          <div 
            className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 rounded-2xl shadow-2xl lg:w-full w-[95%] max-w-4xl overflow-hidden border border-purple-500/20 animate-scaleIn"
          ...
          >
            ...
            <button
              onClick={handleCloseModal}
              className="absolute top-2 right-2 z-20 w-8 h-8 flex items-center justify-center rounded-full bg-gray-800/90 text-gray-400 hover:text-white hover:bg-purple-600 transition-all duration-300 hover:rotate-90 hover:scale-110 backdrop-blur-sm border border-gray-700/50"
            >
            ...
            <div className="flex flex-col md:flex-row h-auto max-h-[90vh]">
              ...
              <div className="relative md:w-1/2 bg-gradient-to-b from-gray-800/50 to-gray-900 p-3 sm:p-4 flex items-center justify-center">
                <div className="relative group w-full">
                  ...
                  <img
                    ...
                    className="relative w-full h-auto max-h-[30vh] md:max-h-[70vh] object-contain rounded-xl shadow-2xl transform group-hover:scale-[1.02] transition-transform duration-500"
                    style={{
                  ...
                  {/* Decorative corners */}
                  <div className="absolute top-2 left-2 w-4 h-4 border-l-2 border-t-2 border-purple-500/50 rounded-tl"></div>
                  <div className="absolute top-2 right-2 w-4 h-4 border-r-2 border-t-2 border-purple-500/50 rounded-tr"></div>
                  <div className="absolute bottom-2 left-2 w-4 h-4 border-l-2 border-b-2 border-purple-500/50 rounded-bl"></div>
                  <div className="absolute bottom-2 right-2 w-4 h-4 border-r-2 border-b-2 border-purple-500/50 rounded-br"></div>
                </div>
              </div>
              
              {/* Content Section */}
              <div className="md:w-1/2 p-4 sm:p-6 pt-8 md:pt-4 flex flex-col justify-center space-y-3 sm:space-y-4">
                {/* Title with gradient */}
                <h3 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-white via-purple-200 to-purple-400 bg-clip-text text-transparent pr-8">
                  {selectedProject.title}
                </h3>
                
                {/* Description */}
                <p className="text-gray-400 text-xs sm:text-sm md:text-base leading-relaxed line-clamp-4 md:line-clamp-6">
                ...
                <div className="flex flex-wrap gap-1.5 sm:gap-2">
                  {selectedProject.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="bg-purple-500/10 text-[10px] sm:text-xs md:text-sm font-medium text-purple-400 rounded-full px-2 sm:px-3 py-1 sm:py-1.5 border border-purple-500/20 hover:border-purple-500/50 hover:bg-purple-500/20 transition-all duration-300 cursor-default"
                ...
                <div className="flex gap-3 sm:gap-4 pt-2 sm:pt-3">
                  {selectedProject.tags.length === 1 && selectedProject.tags[0] === "Figma" ? (
                    <a
                      ...
                      className="w-full relative group bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 text-white px-6 py-3 rounded-xl text-base sm:text-lg font-semibold text-center flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/30 hover:-translate-y-0.5"
                    >
                    ...
                    <>
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-1/2 group relative bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white px-4 sm:px-6 py-3 rounded-xl text-sm sm:text-lg font-semibold text-center flex items-center justify-center gap-2 transition-all duration-300 border border-gray-700 hover:border-purple-500/50 hover:-translate-y-0.5"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-1/2 group relative overflow-hidden bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-500 hover:to-purple-600 text-white px-4 sm:px-6 py-3 rounded-xl text-sm sm:text-lg font-semibold text-center flex items-center justify-center gap-2 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/30 hover:-translate-y-0.5"
                      >
