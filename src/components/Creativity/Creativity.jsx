        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid grid-cols-5 grid-rows-5 gap-4">
            <div className="col-span-5 row-span-2 rounded-2xl border border-white/10 bg-gray-900/70 p-8 shadow-2xl shadow-purple-500/10 backdrop-blur-md transition-all duration-300 hover:border-sky-500/50 hover:shadow-[0_0_40px_rgba(56,189,248,0.35)]">
              <p className="text-sm font-semibold uppercase tracking-[0.35rem] text-sky-300">
                Playful Collabs
              </p>
              ...
              <p className="mt-3 max-w-2xl text-sm text-slate-300 sm:text-base">
                Bring your ideas to life in our real-time drawing and guessing
                arena inspired by Skribbl.io. Sketch wild prompts, guess faster
                than your friends, and keep the streak alive across energetic
                rounds.
              </p>
